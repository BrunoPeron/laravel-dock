...
@section('content')
    <div class="col-md-4 offset-md-1">
        <div class="row" style="padding-top:10px;  background-color: #181818; padding-right: 40px; padding-bottom: 25px; border-radius: 10px; margin-top: 20px">
    ...
    @if(Auth::user()->cargo == 'admin')
        <div class="col-md-4 offset-md-1">
            <div class="row " style="margin-top: 80px; padding-top:10px;  background-color: #181818; padding-right: 40px; padding-bottom: 25px; border-radius: 10px;">
                <div class="col" style="padding-top:10px;">
        ...
        <div class="col-md-4 offset-md-2">
            <div class="row " style="padding-top:10px;  background-color: #181818; padding-right: 40px; padding-bottom: 25px; border-radius: 10px; margin-top: 80px">
                <div class="col" style="padding-top:10px;">
