...
@section('content')
    ...
    <div class="row justify-content-center" style="padding-top:10px; margin-left: 25%; background-color: #181818; padding-right: 40px; padding-bottom: 25px; border-radius: 10px; margin-top: 100px; width: 810px">
